...
export const MobileAccountForm: React.FC = () => {
				...
				try {
					...
					if (result?.data) {
						reset({
							...
							accountOwner: result?.data?.accountOwner,
	...
	const onSubmit = async (data: FormData) => {
		try {
			...
			const url = isEdit ? `${api.mobileAccount}/${id}` : api.mobileAccount;
	...
	return (
		<div className="space-y-6">
			...
			>
				<button
					onClick={() => navigate("/system/mobileAccount")}
