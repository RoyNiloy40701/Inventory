...
export const MobileAccountList: React.FC = () => {
	...
	const deleteMobileAccount = async (id: number) => {
		try {
			...
			setMobileAccount((prevMobileAccount) =>
				prevMobileAccount.filter((mobileAc) => mobileAc._id !== id)
			);
		} catch (error) {
				...
				<div className="flex items-center space-x-4">
					...
					<div>
						...
						<p className="text-gray-600 dark:text-gray-400">
							Manage your mobile account List
						</p>
					</div>
				</div>
				<button
								...
								>
									...
									<td className="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
										<div className="flex items-center justify-end space-x-2">
											...
											<button
												onClick={() =>
													navigate(`/mobileAccount/${mobileAc?._id}/edit`)
												}
											...
											<button
												onClick={() => deleteMobileAccount(mobileAc?._id)}
