...
const fetchPurchase = async () => {
    try {
        const response = await fetch(api.allSale, {
            method: "GET",
            headers: {
...
export const SaleWiseProfitReport: React.FC = () => {
    ...
    useEffect(() => {
        const filtered = purchase.filter((p) => {
            ...
            const matchesSearch =
                ...
                formatDateTime(p.saleDate)?.toLowerCase().includes(search) ||
                            ...
                            {filteredPurchase?.map((data, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 text-sm font-medium text-green-600 whitespace-nowrap dark:text-green-400">
                                        {formatDateTime(data?.saleDate)}
                                    </td>
                                   
                                    <td className="px-6 py-4 text-sm text-gray-900 whitespace-nowrap dark:text-white">
                                       {data?.totalAmount-data?.vAmount}
                                    </td>
                                    ...
                                    <td className="px-6 py-4 text-sm text-gray-900 whitespace-nowrap dark:text-white">
                                       {(data?.totalAmount-data?.vAmount)-data?.totalPurchasePrice}
                                    </td>  
                                </tr>
                            ))}
                        </tbody>
