  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <p className="mt-1 text-light-text-secondary dark:text-dark-text-secondary">Your latest transactions across all currencies</p>
      </motion.div>

      {/* Transaction List */}
      <div className="p-6 transition-colors duration-300 border bg-light-surface/50 dark:bg-dark-surface/50 backdrop-blur-sm border-light-border dark:border-dark-border rounded-2xl shadow-glass">
        <div className="space-y-4">
          {transactions.map((transaction, index) => (
            <motion.div
              ...
              className="relative flex items-center p-4 space-x-4 transition-all duration-300 rounded-xl hover:bg-light-glass dark:hover:bg-dark-glass group"
            >
              {/* Transaction Icon */}
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center mb-1 space-x-2">
                  <p className="font-medium truncate text-light-text dark:text-dark-text font-editorial">{transaction.recipient}</p>
                ...
                <p className="mt-1 text-xs text-light-text-secondary dark:text-dark-text-secondary">{transaction.description}</p>
              </div>
              ...
              <div className="text-right">
                ...
                <p className="mt-1 text-xs text-light-text-secondary dark:text-dark-text-secondary">{transaction.time}</p>
              </div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full py-3 mt-6 font-medium transition-all duration-300 border bg-light-glass dark:bg-dark-glass border-light-border dark:border-dark-border rounded-xl text-light-text dark:text-dark-text hover:border-lime-accent/30 hover:text-lime-accent"
        >
